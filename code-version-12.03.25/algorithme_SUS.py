...
def fonction_selection_SUS(Nb_particules, poids_i, vec_index_p_surface):
...
def resampling_SUS_bruit(Nb_particules, vec_index_p_selec, points_centraux_x_i, points_centraux_z_i, longueurs_okada_i, ouvertures_okada_i, dips_i, strikes_i):
...
def okada_vers_physique_SUS(Nb_particules, vec_index_particules, points_centraux_x_i_re,
