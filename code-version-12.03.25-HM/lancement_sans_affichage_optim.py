...
def lancement_propag_selec(Nb_particules, pas_temps, Nb_propag_init, Nb_pas_max, int_selec, int_aff):
    ...
    #directory_sauvegarde = "/home/zuccalil/WS1-NAS/zuccalil/output_sauvegarde_plots_10.03.25-HM-100pc-2"
    ...
    for i in vec_selection:
        ...
        if i % int_selec == 0:
            ...
            ## Construction de la matrice de covariance  : doit être de taille n
        ...
        ################ Etape de selection
        vec_index_particules = selection_HM(Nb_particules, vecteur_poids_i, vec_index_p_surface)
        print(vec_index_particules)

        points_centraux_x_i_re, points_centraux_z_i_re, longueurs_okada_i_re, ouvertures_okada_i_re, dips_i_re, strikes_i_re = resampling_HM_bruit(Nb_particules, vec_index_particules,
                                                                                                    point_centraux_x_i, point_centraux_z_i, longueurs_okada_i, ouvertures_okada_i, dips_i, strikes_i)



        sauv_parametres, sauv_trajectoires = okada_vers_physique_HM(Nb_particules, vec_index_particules, points_centraux_x_i_re,
...
if __name__ == '__main__':
    lancement_propag_selec(100, 60, 60, 60, 5, 5)    #60   540  60   60
